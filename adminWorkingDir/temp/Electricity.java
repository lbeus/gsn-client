package temp; import gsn.electricity.*;
...
public class Electricity  extends hr.fer.rasip.gsnadmin.DummyAbstractWrapper {
    
    private static final int            DEFAULT_SAMPLING_RATE	= 5000;
    private int                         samplingRate			= DEFAULT_SAMPLING_RATE;
    private static int                  threadCounter			= 0;
    private final transient Logger      logger					= Logger.getLogger(Electricity.class);
