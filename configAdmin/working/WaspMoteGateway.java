package temp; import hr.fer.rasip.wrappers.*;
...
public class WaspMoteGateway  extends hr.fer.rasip.gsnadmin.DummyAbstractWrapper implements SerialPortEventListener {
...
package temp; import is too big. Increase mote-id-length parameter.").*;
		}
		if(data.length()>dataStringLength){
package temp; import is too big. Increase data-string-length parameter.").*;
		}	
